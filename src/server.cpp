...
int main()
{
	...
	/* This allows socket errors and hang-ups to be handled gracefully by the 
	 * implemented throw-catch mechanisms.
	 * If SIGPIPE was not ignored, the server would otherwise exit unexpectedly
	 */
